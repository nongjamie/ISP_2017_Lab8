public class Rec {
	 ...
	 */
	 ...
	 /**
	 * = sum of the digits in the decimal representation of n. e.g.
	 sumDigits(0)
	 ...
	 */
	 ...
	 /**
	 * = a copy of s with to_remove_char removed. Example:
	 removeChar("abeabe",
	 * 'e') = "abab".
	 */
	public static String removeChar(String s, char to_remove_char) {
		if (s.length() > 0) {
			if (s.charAt(0) == to_remove_char) {
				...
				return s.substring(0,1).concat(removeChar(s.substring(1), to_remove_char));
			}
		} else
